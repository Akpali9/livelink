...
const onSubmit = async (data: BusinessFormData) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white pb-32 text-[#1D1D1D]">
      ...
      {/* Footer Navigation */}
      <div className="fixed bottom-0 mb-12 left-0 right-0 p-6 bg-white border-t-2 border-[#1D1D1D] z-50 max-w-[480px] mx-auto" >
    ...
    >
      {loading ? "Submitting..." : "Submit Registration"}
        ...
        {step === 5 && !agreeToTerms && (
          <p className="text-[9px] font-black uppercase text-red-500 mt-3 text-center mb-8">
